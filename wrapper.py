...
####################################################################
host_reference_dir_path =   "/tmp/Host_reference_fasta"   # directory containing host reference sequences
####################################################################
...
#    report_cmd = "Rscript " + nextflow_script_path + "/scripts/6_report_with_knitr_" + platform + ".R --prefix " + prefix + " --markdown " + scripts_path + "6_report_template_" + prefix + ".Rmd"

...
process mapping_summary {
    ...
    output:
        ...
        path "${bam.simpleName}/*"
    """
    /root/bamcov -H $bam > "${bam.simpleName}.txt"
...
process add_header_filter {
    ...
    """
    cat /root/headers/bamcov_header $collection > ${params.prefix}.tmp
    python /root/scripts/2_reference_mapping_result_filter.py --input ${params.prefix}.tmp --output ${params.prefix}.reference_mapping.txt --min_avg_cov ${params.reference_mapping_minimum_avg_coverage}
    """
}
